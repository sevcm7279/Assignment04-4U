...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (d2.isCollideDalek(d1) == true || d2.isCollideDalek(d3) == true) {
            ...
            if (doc.isCollide(d1) || doc.isCollide(d2) || doc.isCollide(d3)) {
                ...
                // display win message
                board.displayMessage("You lose! The doctor has been captured by the daleks.");
                // stop the game
                break;
            }
            
            // if all of the daleks have crashed
            if (d1.hasDied() == true && d2.hasDied() == true && d3.hasDied() == true) {
                // display you win
                board.displayMessage("You win! The daleks are dumb and died.");
                // stop the game
                break;
            }
        }
